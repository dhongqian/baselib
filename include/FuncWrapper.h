...
namespace hq
{
  ...
  struct Execute
  {
    ...
    {
      Execute<F, Tuple, Total == 1 + sizeof...(N), Total, N..., sizeof...(N)>::call(f, std::forward<Tuple>(t));
    }
  };
  ...
  void FuncExecuteRun(F& f, Tuple && t)
  {
    ...
    Execute<F, Tuple, 0 == std::tuple_size<ttype>::value, std::tuple_size<ttype>::value>::call(f, std::forward<Tuple>(t));
  }
